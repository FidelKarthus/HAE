...
;pract5a.c,21 :: 		void interrupt() //se ha pulsado una tecla
;pract5a.c,23 :: 		if (algo==17)
	MOVF        _algo+0, 0 
	XORLW       17
	BTFSS       STATUS+0, 2 
	GOTO        L_interrupt11
;pract5a.c,25 :: 		algo = 1;
	MOVLW       1
	MOVWF       _algo+0 
;pract5a.c,26 :: 		lcd_cmd(_lcd_clear);
	MOVLW       1
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;pract5a.c,27 :: 		}
L_interrupt11:
;pract5a.c,28 :: 		key=tecla();
	CALL        _tecla+0, 0
	MOVF        R0, 0 
	MOVWF       _key+0 
;pract5a.c,29 :: 		lcd_chr(1,algo,key);
	MOVLW       1
...
;pract5a.c,30 :: 		algo++;
	INCF        _algo+0, 1 
;pract5a.c,31 :: 		x=PORTB; //hay que leer el puerto B para poder borrar el bit RBIF (define x global)
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;pract5a.c,32 :: 		INTCON.RBIF=0;//Al borrar el bit RBIF despues de llamar a la funcion tecla, nos
	BCF         INTCON+0, 0 
;pract5a.c,33 :: 		}           //aseguramos que después de soltar la tecla éste bit se pone a 0.
L_end_interrupt:
L__interrupt14:
	RETFIE      1
; end of _interrupt
...
;pract5a.c,38 :: 		void main() {
;pract5a.c,39 :: 		TRISB=0xF0;  // el nibble alto son entradas y el nibble bajo son salidas
	MOVLW       240
	MOVWF       TRISB+0 
;pract5a.c,40 :: 		PORTB=0;
	CLRF        PORTB+0 
;pract5a.c,41 :: 		Lcd_Init();
	CALL        _Lcd_Init+0, 0
;pract5a.c,43 :: 		INTCON2.RBPU=0; //se habilitan las resistencias de pullup de las entradas del PORTB
	BCF         INTCON2+0, 7 
;pract5a.c,44 :: 		x=PORTB;//para poder borrar el RBIF
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;pract5a.c,45 :: 		INTCON.RBIF=0;
	BCF         INTCON+0, 0 
;pract5a.c,46 :: 		INTCON.RBIE=1;
	BSF         INTCON+0, 3 
;pract5a.c,47 :: 		INTCON.GIE=1;
	BSF         INTCON+0, 7 
;pract5a.c,49 :: 		}
L_end_main:
	GOTO        $+0
